...
def _detect_facts_and_type(text_blob: str) -> Tuple[str, str, List[str]]:
    ...
    # Semáforo (robusto): muchos boletines redactan de forma enredada.
# Ejemplo real: "no respetar ... la luz roja no intermitente de un semáforo".
# Activadores fuertes:
sema_signal = (
    ("semáfor" in t) or ("semafor" in t)
    or ("fase roja" in t)
...
# Evitar falsos positivos por alumbrado/luces del vehículo
