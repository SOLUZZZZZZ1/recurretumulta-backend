...
class CheckoutRequest(BaseModel):
    ...
    product: str = Field(..., description="DGT_PRESENTACION | AYTO_PRESENTACION | CASO_COMPLEJO")
...
def create_checkout(req: CheckoutRequest):
    try:
        ...
        frontend_url = _optional("FRONTEND_URL", "https://www.recurretumulta.eu")
        ...
        if case_id:
            ...
            with engine.begin() as conn:
                ...
                conn.execute(
                    ...
                    {"case_id": case_id, "payload": json.dumps({"product": product, "stripe_session_id": session_id})},
                )
