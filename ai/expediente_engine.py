...
# ==========================
# ASE-CICLISTA — ATENCIÓN (ART. 18) CON CONTEXTO BICICLETA/CICLISTA
# ==========================
...
def _ase_ciclista_block() -> str:
    return (
        "ALEGACIÓN PRIMERA — INSUFICIENCIA PROBATORIA Y FALTA DE CONCRECIÓN DE LA CONDUCTA (ART. 18 RGC)\n\n"
        "En infracciones atribuidas a ciclistas por supuesto incumplimiento del artículo 18 del Reglamento General de Circulación "
        "(no mantener la atención permanente), la exigencia de motivación y concreción fáctica debe ser especialmente rigurosa.\n\n"
        "No consta acreditado en el expediente, de forma específica:\n"
        "1) Qué acción concreta realizaba el ciclista que pudiera considerarse distracción.\n"
        "2) Durante cuánto tiempo se prolongó dicha conducta.\n"
        "3) En qué medida dicha acción afectó efectivamente a la conducción.\n"
        "4) Si existió maniobra irregular, invasión de carril, pérdida de trayectoria o situación objetiva de riesgo.\n"
        "5) La posición exacta del agente denunciante y la distancia aproximada de observación.\n"
        "6) Las condiciones de visibilidad (tráfico, iluminación, obstáculos).\n"
        "7) Si existe prueba objetiva (fotografía o vídeo) o si la imputación se basa exclusivamente en apreciación visual.\n\n"
        "La simple afirmación genérica de 'no mantener la atención permanente' constituye una fórmula estereotipada que no permite "
        "ejercer contradicción efectiva. En ausencia de descripción concreta y de circunstancias objetivas verificables, procede el ARCHIVO "
        "por insuficiencia probatoria.\n\n"
        "ALEGACIÓN SEGUNDA — PRINCIPIO DE TIPICIDAD Y SUBSUNCIÓN\n\n"
        "Conversar o interactuar verbalmente mientras se circula en grupo no constituye por sí mismo infracción si no se acredita una "
        "afectación efectiva y concreta a la seguridad vial. La ausencia de concreción impide la correcta subsunción del hecho en el tipo sancionador.\n\n"
    )

def _apply_ase_ciclista(body: str) -> str:
    """Inserta bloque ASE-CICLISTA y evita duplicaciones de alegación primera."""
    if not body:
        body = ""
    block = _ase_ciclista_block()
